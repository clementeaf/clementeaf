...
/**
 * Props del componente QuotesFilters
 */
 ...
 * @param props - Props del componente QuotesFilters
 * @returns Componente QuotesFilters
 */
export const QuotesFilters = ({ className = '' }: QuotesFiltersProps) => {
