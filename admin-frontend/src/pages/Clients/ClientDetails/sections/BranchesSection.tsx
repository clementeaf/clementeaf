 ...
 */
export const BranchesSection = ({ clientId: _clientId }: BranchesSectionProps): React.ReactElement => {
  // TODO: Implementar cuando exista el endpoint de sucursales
  // clientId será usado cuando se implemente la funcionalidad de sucursales
  return (
